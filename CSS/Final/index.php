...
<body>
    <main>
      <section id="banner">
        <img src="https://s17.postimg.org/3rojs63kf/banner.jpg">
        <div class="contenedor">
      ...
      <section id="blog">
        ...
        <div class="contenedor">
          <article>
            <img src="https://perro.shop/wp-content/uploads/boxer_cachorros.jpg">
            <h4>Esconge tu mascota perfecta</h4>
          </article>
          <article>
            <img src="https://www.elnacional.com/wp-content/uploads/2020/08/gato.jpg">
            <h4>Los animales necesitan cariño</h4>
          </article>
          <article>
            <img src="https://vcm.emol.com/wp-content/uploads/2018/11/cotorra-argentina.jpg">
      ...
      <section id="info">
        ...
        <div class="contenedor">
          <div class="info-pet">
            <img src="imagenes/pet1.jpg" alt="">
            <h4>Max</h4>
          </div>
          <div class="info-pet">
            <img src="imagenes/pet2.jpg" alt="">
            <h4>Jerry</h4>
          </div>
          <div class="info-pet">
            <img src="imagenes/pet3.png" alt="">
            <h4>Tom</h4>
          </div>
          <div class="info-pet">
            <img src="imagenes/pet4.png" alt="">
            <h4>Sam</h4>
          </div>
        </div>
      </section>
    ...
    <footer>
      <div class="contenedor">
        <p class="copy">Ray &copy; 2020</p>
        <div class="sociales">
          <a class="fontawesome-facebook-sign" href="https://www.facebook.com/"></a>
